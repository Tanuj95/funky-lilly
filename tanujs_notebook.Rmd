---
title: "R Notebook Shera Thundercats Transformers Aug 16"
...
This is the import process for the clinical data
...
```{r}
simulated_patient_data %>%
 filter(birthdate >= "1965-05-26" & birthdate <= "2020-11-09") %>%
